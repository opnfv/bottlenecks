...
function fn_parser_ipaddress(){
    ...
    target_control_private_ip=`heat output-show ${STACK_NAME} target_control_private_ip`
    target_control_public_ip=`heat output-show ${STACK_NAME} target_control_public_ip`
    ...
    tester_control_private_ip=`heat output-show ${STACK_NAME} tester_control_private_ip`
    tester_control_public_ip=`heat output-show ${STACK_NAME} tester_control_public_ip`
