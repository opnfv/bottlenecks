...
from utils.infra_setup.common import template_format
...
class HeatTemplate(HeatObject):
    ...
    def _init_template(self):
        ...
        self._template['description'] = \
            '''Stack built by the bottlenecks framework for %s on host %s %s.
    ...
    def __init__(self, name, template_file=None, heat_parameters=None):
        ...
        # bottlenecks creates the template (no get_param in resources part)
        if heat_parameters:
        ...
        self.resources[name] = {
            ...
            'properties': {
                ...
                'public_key': pkg_resources.resource_string(
                    'bottlenecks.resources', 'files/bottlenecks_key.pub')
            }
        }
