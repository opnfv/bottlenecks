...
1. Bottlenecks eliminates the environments limits/constraints
2. Bottlenecks tells Yardstick to prepare environment
3. Bottlenecks tells Yardstick to run test
4. Bottlenecks collects testing results from Yardstick
5. Bottlenecks tells Yardstick to stop when time ends
   or system fails the test 
6. Bottlenecks sends testing data to bottlenecks-elk'''
...
import testsuites.posca.testcase_dashboard.posca_factor_throughputs as DashBoard
