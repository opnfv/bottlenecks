...
with open('posca_system_bandwidth_index_pattern.json') as index_pattern:
...
with open('posca_system_bandwidth_config.json') as index_config:
...
with open('posca_system_bandwidth_discover.json') as index_discover:
...
with open('posca_system_bandwidth_line_data.json') as line_data:
...
with open('posca_system_bandwidth_line_char.json') as line_char:
...
with open('posca_system_bandwidth_terms_data.json') as terms_char:
...
# Create dashboard
with open('posca_system_bandwidth_dashboard.json') as dashboard:
